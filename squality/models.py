...
class ScoringFinale(models.Model):
    ...
    wcbm = models.IntegerField(default=0, blank=True, null=True)
    acbm = models.IntegerField(default=0, blank=True, null=True)
    ncam = models.IntegerField(default=0, blank=True, null=True)
    imc = models.IntegerField(default=0, blank=True, null=True)
    nmo = models.IntegerField(default=0, blank=True, null=True)
    trm = models.IntegerField(default=0, blank=True, null=True)
    mloc = models.IntegerField(default=0, blank=True, null=True)
    mnoc = models.IntegerField(default=0, blank=True, null=True)
